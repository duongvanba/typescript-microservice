...
export const [AllowFromRemote, listAllowFromRemote] = D.createPropertyDecorator<AllowFromRemoteOptions>(async function (config) {


    for (const { method, options: { concurrency, connection, fanout, limit, route }, prototype } of config) {
